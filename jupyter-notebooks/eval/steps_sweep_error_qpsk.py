...
tikzplotlib.save('../../../bachelorarbeit-ausarbeitung/figures/plots/steps_sweep_qpsk_full.tex', figure=fig1, figureheight="\\figheight", figurewidth="\\figwidth")
tikzplotlib.save('../../../bachelorarbeit-ausarbeitung/figures/plots/steps_sweep_qpsk_zoom.tex', figure=fig2, figureheight="\\figheight", figurewidth="\\figwidth")
tikzplotlib.save('../../../bachelorarbeit-ausarbeitung/figures/plots/steps_sweep_qpsk_full_noalpha.tex', figure=fig3, figureheight="\\figheight", figurewidth="\\figwidth")
tikzplotlib.save('../../../bachelorarbeit-ausarbeitung/figures/plots/steps_sweep_qpsk_zoom_noalpha.tex', figure=fig4, figureheight="\\figheight", figurewidth="\\figwidth")
